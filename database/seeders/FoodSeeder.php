...
use App\Models\menu; // Pastikan huruf kecil/besarnya sama dengan nama file Model kamu
...
class FoodSeeder extends Seeder
{
    ...
    {
        // 1. Data menu manual yang disesuaikan dengan Model 'menu'
        $menuItems = [
            [
        ...
        // 2. Tambahkan 10 data acak otomatis
        // Pastikan di Model menu kamu sudah ditambahkan: use HasFactory;

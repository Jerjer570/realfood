        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="group bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
                <div class="relative aspect-square overflow-hidden">
                    <img src="{{ asset('images/' . $item->gambar) }}" alt="{{ $item->nama }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="p-6 space-y-3">
                    <div class="flex items-center justify-between">
                        <h3 class="text-xl text-gray-900 font-semibold">{{ $item->nama_menu }}</h3>
                    ...
                    <div class="flex items-center justify-between pt-2">
                        <span class="text-xl text-green-600 font-bold">Rp {{ number_format($item->harga, 0, ',', '.') }}</span>
                        <a href="{{ route('menu') }}">

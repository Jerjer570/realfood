    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-lg transition-all">
            <div class="flex items-center gap-5">
                ...
                <div>
                    <p class="text-[10px] text-gray-400 font-black uppercase tracking-widest">Pendapatan Total</p>
        ...
        <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-lg transition-all">
            <div class="flex items-center gap-5">
                <div class="p-4 bg-lime-500 text-white rounded-2xl shadow-lg">
                    <i class="fas fa-dollar-sign text-xl"></i>
                </div>
                <div>
                    <p class="text-[10px] text-gray-400 font-black uppercase tracking-widest">Pendapatan dari Pesanan</p>
                    <h3 class="text-2xl font-black text-gray-900">Rp {{ number_format($totalPendapatanPesanan, 0, ',', '.') }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-lg transition-all">
            <div class="flex items-center gap-5">
                <div class="p-4 bg-yellow-500 text-white rounded-2xl shadow-lg">
                    <i class="fas fa-dollar-sign text-xl"></i>
                </div>
                <div>
                    <p class="text-[10px] text-gray-400 font-black uppercase tracking-widest">Pendapatan dari Ongkir</p>
                    <h3 class="text-2xl font-black text-gray-900">Rp {{ number_format($totalPendapatanOngkir, 0, ',', '.') }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-lg transition-all">
            <div class="flex items-center gap-5">
                ...
                <div>
                    <p class="text-[10px] text-gray-400 font-black uppercase tracking-widest">Rata-rata. pesanan</p>
    ...
    function exportFinancialExcel(btn) {
        ...
        try {
            const data = [
                ...
                ["Total Pendapatan dari Pesanan", "Rp {{ number_format($totalPendapatanPesanan, 0, ',', '.') }}"],
                ["Total Pendapatan dari Ongkir", "Rp {{ number_format($totalPendapatanOngkir, 0, ',', '.') }}"],
                ["Total Pesanan", "{{ $totalOrders }}"],
                ["Total Pelanggan", "{{ $totalCustomers }}"],
                ["Rata-rata pesanan Value", "Rp {{ number_format($averageOrderValue, 0, ',', '.') }}"]
            ];
